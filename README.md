...
- `__(number, [defaultValue])`
  ...
  Выводится локализованная строка или `defaultValue`, если определено. Если не указать `defaultValue`, то вернётся заглушка `[get text]`. 
=======
>>>>>>> 91c6c0fbd0b96cdf9895c64f8b0f5fcd6130af08
